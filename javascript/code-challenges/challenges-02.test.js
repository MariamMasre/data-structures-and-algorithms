...
const extractAbilities = (arr) => {
  let arre=[];
  arr.abilities.forEach( (val, i) => {
    arre[i]=arr.abilities[i]. ability.name; 
...
const extractStats = (arr) => {
  let arre=[];
  arr.stats.forEach( (val, i) => {
    arre[i]={name:arr.stats[i].stat.name,total:arr.stats[i].effort +arr.stats[i].baseStat} 
